...
### Fixed
- Fixed OAuth credentials not being included in packaged builds (.env not bundled)
- Hardcoded OAuth client credentials for distribution

## [2.0.1] - 2026-01-16

### Fixed
- Added OAuth debugging output to diagnose authentication issues
- Improved logging during OAuth flow
